...
export default function Home() {
  ...
  const throttled = useCallback(debounce((e) => { wheelFlip(e) }, 100), [slide]);
  ...
  return (
    <>
      ...
      <main {...handlers} className={styles.home} onWheel={(e) => { console.log("wheel"); throttled(e) }}>
        {/* <GridCon /> */}
        {(slide == 0) && < Hero slide={slide} />}
        {(slide == 1) && < Sec1 slide={slide} />}
        {(slide == 2) && <Sec2 slide={slide} />}
        {(slide == 3) && <Sec3 slide={slide} />}
        {(slide == 4) && <Sec4 slide={slide} />}
        {(slide == 5) && <Sec5 slide={slide} />}
        {(slide == 6) && <Sec6 slide={slide} />}
        {(slide == 7) && <Sec7 slide={slide} />}
      </main>
    </>
  )
...
function Sec2() {
  return <section className={styles.sec2}>
    <GridCon /> 
...
function Sec7() {
  return <section className={styles.sec7}>
    <GridCon /> 
...
function Sec6() {
  return <section className={styles.sec6}>
    <GridCon /> 
...
function Sec5() {
  return <section className={styles.sec5}>
    <GridCon /> 
...
function Sec4() {
  return <section className={styles.sec4}>
    <GridCon /> 
...
function Sec3() {
  return <section className={styles.sec3}>
    <GridCon /> 
